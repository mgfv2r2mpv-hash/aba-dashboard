...
export declare function clientAvailBarStyle(name?: string): {
...
export declare function legendStripeStyle(techName: string): {
    backgroundColor: string;
    backgroundImage: string;
};
//# sourceMappingURL=calendarColors.d.ts.map