                ...
                boxSizing: 'border-box',
                                    ...
                                    borderRadius: '2px',
                                                ...
                                                whiteSpace: 'nowrap',
                                                            ...
                                                            }, style: { ...inputStyle, maxWidth: '180px' } })] }), _jsx(WeeklyAvailability, { availability: c.availabilityWindows, onChange: (av) => updateClient(c.id, { availabilityWindows: av }), defaultWindow: { start: '15:00', end: '19:00' } })] }, c.id))), clients.length === 0 && (_jsx("p", { style: { color: '#9ca3af', textAlign: 'center', padding: '20px' }, children: "No clients yet. Click \"+ Add Client\" to start." }))] })] })), step === 'technicians' && (_jsxs("div", { children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', gap: '8px' }, children: [_jsxs("h3", { style: { fontSize: '18px', margin: 0 }, children: ["Technicians (", technicians.length, ")"] }), _jsx("button", { onClick: addTechnician, style: {
                                                padding: '6px 12px', backgroundColor: '#3b82f6', color: 'white',
                                                border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '13px',
                                                whiteSpace: 'nowrap',
                                            }, children: "+ Add Technician" })] }), _jsx("p", { style: { color: '#6b7280', fontSize: '13px', marginBottom: '12px' }, children: "Mark RBT certification (affects supervision math). Add availability and client assignments." }), _jsxs("div", { style: { display: 'grid', gap: '12px' }, children: [technicians.map(t => (_jsxs("div", { style: cardStyle, children: [_jsxs("div", { style: { display: 'flex', gap: '8px', marginBottom: '8px', alignItems: 'center', flexWrap: 'wrap' }, children: [_jsx("input", { value: t.name, onChange: (e) => updateTechnician(t.id, { name: e.target.value }), placeholder: "Technician name", style: { ...inputStyle, flex: '1 1 140px', minWidth: 0 } }), _jsxs("label", { style: { display: 'flex', gap: '4px', alignItems: 'center', whiteSpace: 'nowrap', fontSize: '13px' }, children: [_jsx("input", { type: "checkbox", checked: t.isRBT, onChange: (e) => updateTechnician(t.id, { isRBT: e.target.checked }) }), _jsx("span", { children: "RBT" })] }), _jsx("button", { onClick: () => removeTechnician(t.id), style: {
                                                                padding: '6px 10px', backgroundColor: '#fee2e2', color: '#dc2626',
                                                                border: '1px solid #fca5a5', borderRadius: '4px', cursor: 'pointer',
                                                                whiteSpace: 'nowrap',
                                                            }, children: "Remove" })] }), _jsx(WeeklyAvailability, { availability: t.availability, onChange: (av) => updateTechnician(t.id, { availability: av }), defaultWindow: { start: '15:00', end: '19:00' } }), _jsxs("div", { style: { marginTop: '10px' }, children: [_jsx("label", { style: labelStyle, children: "Assignments" }), t.assignments.map((a, idx) => {
                                                            const assignmentKey = `${t.id}_${idx}`;
                                                            const hoursStr = assignmentHoursStr[assignmentKey] ?? String(a.hoursPerWeek);
                                                            return (_jsxs("div", { style: { display: 'flex', gap: '6px', marginBottom: '6px', alignItems: 'center' }, children: [_jsxs("select", { value: a.clientId, onChange: (e) => {
                                                                        ...
                                                                        }, style: { ...inputStyle, flex: 2, minWidth: 0 }, children: [_jsx("option", { value: "", children: "\u2014 Pick client \u2014" }), clients.map(c => _jsx("option", { value: c.name, children: c.name }, c.id))] }), _jsx("input", { type: "number", step: "0.5", placeholder: "hrs/wk", value: hoursStr, onChange: (e) => setAssignmentHoursStr({ ...assignmentHoursStr, [assignmentKey]: e.target.value }), style: { ...inputStyle, flex: 1, minWidth: 0 } }), _jsx("button", { onClick: () => {
...
function WeeklyAvailability({ availability, onChange, defaultWindow }) {
    const seedWindow = defaultWindow ?? { start: '09:00', end: '17:00' };
    ...
    return (_jsxs("div", { children: [_jsxs("div", { style: {
                ...
                }, children: [_jsx("button", { onClick: () => setWeekdays({ start: '09:00', end: '17:00' }), style: presetBtn, title: "Mon\u2013Fri 9 AM\u20135 PM", children: "Weekdays 9\u20135" }), _jsx("button", { onClick: () => setWeekdays({ start: '15:00', end: '19:00' }), style: presetBtn, title: "Mon\u2013Fri 3 PM\u20137 PM", children: "After-school 3\u20137" }), _jsx("button", { onClick: copyMondayToWeekdays, style: presetBtn, title: "Copy Monday to Tue\u2013Fri", children: "Copy Mon \u2192 Tue\u2013Fri" }), _jsx("button", { onClick: clearAll, style: { ...presetBtn, color: '#dc2626', borderColor: '#fca5a5' }, children: "Clear all" })] }), _jsx("div", { style: { display: 'grid', gap: '4px' }, children: DAYS.map(day => {
                    ...
                    return (_jsxs("div", { style: {
                            ...
                            border: '1px solid #e5e7eb',
                                ...
                                }, children: day.slice(0, 3) }), windows.length === 0 && (_jsx("span", { style: { fontSize: '12px', color: '#9ca3af', fontStyle: 'italic' }, children: "Off" })), windows.map((w, idx) => (_jsxs("span", { style: windowChipStyle, children: [_jsx("input", { type: "time", value: w.start, onChange: (e) => updateWindow(day, idx, 'start', e.target.value), style: chipTimeInput }), _jsx("span", { style: { fontSize: '12px', color: '#6b7280' }, children: "\u2013" }), _jsx("input", { type: "time", value: w.end, onChange: (e) => updateWindow(day, idx, 'end', e.target.value), style: chipTimeInput }), _jsx("button", { onClick: () => removeWindow(day, idx), style: chipRemoveBtn, title: "Remove this window", "aria-label": "Remove time window", children: "\u00D7" })] }, idx))), _jsx("button", { onClick: () => addWindow(day), style: addWindowBtn, title: `Add a time window on ${day}`, children: "+ window" }), windows.length > 0 && (_jsx("button", { onClick: () => clearDay(day), style: offBtn, title: `Clear ${day}`, children: "Off" }))] }, day));
                }) })] }));
}
const presetBtn = {
    padding: '4px 10px',
