...
export default function WishComposer({ data, aiSettings, onAccept, onCustomize, onClose }) {
    const [wish, setWish] = useState({ kind: 'vacation', horizonWeeks: 8 });
