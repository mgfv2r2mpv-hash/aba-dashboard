...
export function clientAvailBarStyle(name?: string): { backgroundColor: string; borderColor: string; color: string } {
  if (!name) return { backgroundColor: '#e5e7eb', borderColor: '#9ca3af', color: '#374151' };
